    ...
    GuiSubmesh = gui.addFolder("Submesh Toggle");
     glbscene.scene.traverse( function ( child ) {
      ...
      if ( child.isMesh ) {
        ...
        strGLBInfo = strGLBInfo + "<p class='eq-lay1 rounded'><span class='badge layer-1 w-100 rounded-0'>"+child.name+"</span><details class='eq-lay1 text-white'><summary class='bg-info p-1 text-dark'>Material names</summary><ul><li>"+child.userData.materialNames.toString().replaceAll(",","</li><li>")+"</li></ul></details></p>";
